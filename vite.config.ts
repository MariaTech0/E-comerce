...
import { resolve } from "path"; // path padrão
...
export default defineConfig({
  ...
  define: {
    ...
    __READDY_AI_DOMAIN__: JSON.stringify(
      process.env.READDY_AI_DOMAIN || "https://readdy.ai"
    ),
  },
  plugins: [
    react(),
  ...
  build: {
    sourcemap: false, // true para debug, false produção
    outDir: "out",     // pasta final do build
